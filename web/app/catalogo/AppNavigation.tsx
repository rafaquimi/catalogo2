...
export function AppNavigation({ email }: { email?: string | null }) {
  ...
  return (
    <>
      ...
      <header className="mobile-safe-header sticky top-0 z-30 flex items-center justify-between border-b border-slate-200/80 bg-white/90 px-4 backdrop-blur-xl dark:border-slate-800 dark:bg-slate-950/90 lg:hidden">
